...
header("Content-Disposition: attachment;Filename=Расписание врачей на ".date("Y-m-d").".xls");
header("Content-Transfer-Encoding: binary");
echo '<meta charset="UTF-8">';
include "../connection_code_to_data_base.php";
?>
<center> <?php echo("<font face='Times New Roman'><b>Расписание врачей на ".date("Y-m-d")."</b></font>") ?></center>
<table border="5">
        <tr>
