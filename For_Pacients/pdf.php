...
$date=(date('d-m-Y'));
$query=mysqli_query($connect,"SELECT op.DATAOPL, op.SUMOPL, d.ADRDOM, k.NUMBKV, o.FAMOK, o.NAMOK, o.OTCHOK,u.LOG 
FROM opl op, chetcomm c, kvar k, dom d, ownkv o, users u 
WHERE d.IDDOM=k.IDDOM AND op.IDCHETCOMM=c.IDCHETCOMM and c.IDKV=k.IDKV and k.IDOK=o.IDOK and o.ID_USERS=u.ID_USERS AND op.IDOPL='$id';");
...
color:black'>1. Фамилия, Имя, Отчество: ".$fio[0]." <br>
...
$customPaper = array(0,0,1000,200);
$dompdf->set_paper($customPaper);
// Render the HTML as PDF - рендерим
$dompdf->render();
// Output the generated PDF to Browser
$dompdf->stream('Чек от '.$date.'.pdf',array('Attachment'=>0))
